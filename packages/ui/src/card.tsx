    ...
    <div className='max-w-sm bg-white border border-gray-200 shadow-md rounded-lg trasform-all duration-300 hover:scale-110 hover:shadow-lg' >
            ...
            <div className="p-5">
                ...
                <div className='flex flex-col justify-center items-center'>
                  ...
                  <a href="#" className=" inline-flex items-center px-3 py-2 text-sm font-medium text-center text-black bg-white rounded-lg hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-white dark:hover:bg-gray-200 dark:focus:ring-gray-200">
                      Read more
